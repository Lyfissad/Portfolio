...
export default function ExpiTile(props){
    return(
        <div className="mt-7 md:relative md:left-[37%] midlg:left-[25rem] lg:left-[25rem]">
            <h1 className="text-faded text-xl whitespace-break-spaces md:relative md:left-[3rem]">{props.position}<span className="text-green text-lg"> @ {props.company}</span></h1>
            <h3 className="text-slightFade mt-4 md:relative md:left-[3rem]">{props.timeLine}</h3>
            <ul className="text-slightFade mt-8 space-y-4 md:max-w-[40%] midlg:max-w-[%] md:ml-[3rem]">
