    ...
    return(
        <div className="animate-fadeInL mt-7 bg-lightNavy w-[92%] h-[415px] md:h-[30rem] lg:h-[30rem] shadow-3xl rounded-lg relative">
            <div className="ml-5 pt-6">
                ...
                {props.details}
                {props.deployed && <a href={props.deployed} rel="noopener noreferrer" target="_blank"><span className="text-green">  LIVE DEMO.</span></a>}
                </h4>
            </div>
            <a
            ...
            <h4 className="absolute bottom-4 right-5 text-darkSlate hover:text-green cursor-pointer transition-all ease-in duration-100 font-semibold text-sm md:text-md xl:text-lg">
                {props.stacks}
            </h4>
        </div>
)
