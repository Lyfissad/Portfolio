...
export default function Intro(props){
    return(
        <div className={props.blur? "pt-10 blur-sm shadow-lg absolute z-2" : "text-left pt-10 absolute"}>
            ...
            <h4 className="text-slightFade m-7 text-lg p-3">I have been working with Web apps for about 3 years now and am currently working at
