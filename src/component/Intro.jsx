...
export default function Intro(props){
    return(
        <div class="dark" className={`mb-[40vh] mt-52 text-left pt-5 md:mt-[30vh] md:ml-20 ${props.blur? "blur-sm shadow-lg z-2" : ""}`}>
            ...
            <h3 className="m-9 text-3xl text-slightFade animate-fadeInM md:text-6xl">I build web applications.</h3>
            <h4 className="text-slightFade font-semiHead m-7 -mt-3 text-base p-3 animate-fadeInL md:text-md md:ml-6 md:mr-60">I’m a software engineer with expertise in creating and designing outstanding digital solutions.
