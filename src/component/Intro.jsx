    ...
    return(
        <div class="dark" className={`mb-[40vh] relative
         mt-52 text-left pt-5 md:mt-[30vh] md:left-[20%] md:mr-64 ${props.blur? "blur-sm shadow-lg z-2" : ""}`}>
            ...
            <h3 className="m-9 lg:text-4xl text-slate max-w-[50rem] animate-fadeInM md:text-6xl">MERN Stack Developer building fast, scalable web apps — available for remote roles</h3>
