...
prevScrollpos = currentScrollPos;
  ...
  return (
    <div className="bg-navy scrollbar-thin max-w-screen">
      ...
      <ul className="fixed bottom-32 left-[2.1rem] md:visible xs:invisible">
      ...
      <hr className="md:visible h-24 bottom-1 w-px fixed transition-all animate-fadeInS left-[3rem] bg-slightFade  xs:invisible"></hr>
      <a href="mailto:muazzin2009@gmail.com" className="no-underline"><p className="origin-bottom rotate-90 animate-fadeInNoMove text-slightFade font-semiHead fixed -right-[2.2rem] bottom-56 md:visible xs:invisible transition-all duration-300 hover:text-green hover:-translate-y-1">muazzin2009@gmail.com</p></a>
      <hr className="md:visible h-24 bottom-1 w-px fixed right-[3rem] animate-fadeInS bg-slightFade xs:invisible"></hr>
    </div>
  );
};